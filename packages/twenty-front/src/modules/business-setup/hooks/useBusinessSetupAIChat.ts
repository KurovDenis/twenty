...
type BusinessSetupStep = 'WELCOME' | 'BUSINESS_ANALYSIS' | 'SALES_FUNNEL_DESIGN';
...
export const useBusinessSetupAIChat = () => {
  ...
  const openContextualChat = useCallback((step: BusinessSetupStep) => {
    const messages: Record<BusinessSetupStep, string> = {
      'WELCOME': "I'm ready to help you set up your business automation! Let's get started.",
      'BUSINESS_ANALYSIS': "Let's analyze your business together. What industry are you in?",
      'SALES_FUNNEL_DESIGN': "Great! Now let's design your sales funnel. What's your current conversion rate?",
    };
