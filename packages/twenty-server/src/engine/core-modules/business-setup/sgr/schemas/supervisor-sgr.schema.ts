...
export const SupervisorStepSchema = z.object({
  ...
  function: z.discriminatedUnion('tool', [
    ...
    z.object({
      ...
      success: z.boolean()
        .describe('Whether routing was successful'),
 ...
 */
export type CheckBusinessSetupStatusTool = Extract<SupervisorStepResult['function'], { tool: 'check_business_setup_status' }>;
export type RouteToSpecializedAgentTool = Extract<SupervisorStepResult['function'], { tool: 'route_to_specialized_agent' }>;
export type ProcessDirectlyTool = Extract<SupervisorStepResult['function'], { tool: 'process_directly' }>;
export type StatusChangeTool = Extract<SupervisorStepResult['function'], { tool: 'status_change' }>;
export type CompleteRoutingTool = Extract<SupervisorStepResult['function'], { tool: 'complete_routing' }>;
 ...
 */
export function isCompletionTool(tool: SupervisorToolFunction): tool is CompleteRoutingTool {
 ...
 */
export function isRoutingTool(tool: SupervisorToolFunction): tool is RouteToSpecializedAgentTool {
 ...
 */
export function isStatusChangeTool(tool: SupervisorToolFunction): tool is StatusChangeTool {
